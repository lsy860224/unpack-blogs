...
![비개발자의 Claude Code 바이브 코딩 워크플로우 — 6단계](/images/building-app-with-claude-code/workflow.png)
...
블로그도 직접 만들었다. 그 이야기는 <Link href="/blog/week1-sprint-two-blogs">이전 글</Link>에서 썼다. Claude Code·Cursor 도구 선택 근거가 궁금하면 AIGrit 쪽 <Link href="https://aigrit.dev/ko/blog/claude-code-vs-cursor">Claude Code vs Cursor 비교</Link>가 참고가 된다. 작업 시간 배분 원칙은 <Link href="/blog/time-management-solo-builder">1인 빌더 시간 관리</Link>에 상세히 남겼다.
