...
![Claude 4 Sonnet vs GPT-4o — score comparison across five tasks](/images/claude-4-sonnet-vs-gpt-4o/02-benchmark-chart.png)
...
![Token cost vs latency scatter](/images/claude-4-sonnet-vs-gpt-4o/03-cost-timeline.png)
<figcaption style={{ textAlign: "center", fontSize: "0.9rem", color: "#64748b", marginTop: "-0.5rem", marginBottom: "2rem" }}>
...
![Composite score: Claude 4 Sonnet 8.6 vs GPT-4o 8.4 across five tasks](/images/claude-4-sonnet-vs-gpt-4o/04-score-comparison.png)
