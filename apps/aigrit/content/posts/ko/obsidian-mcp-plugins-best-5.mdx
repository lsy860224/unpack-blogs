...
이 글은 지식관리 cluster의 "Obsidian 자동화" 한 축을 다뤘다. 노트앱 자체를 무엇으로 고를지부터 다시 따져야 한다면 <Link href="/ko/blog/notion-alternatives-best-5">Notion 대체 앱 BEST 5</Link> Pillar에서 Obsidian이 본인 사용 패턴에 맞는 선택인지 5개 앱과 함께 매트릭스로 비교할 수 있다.
